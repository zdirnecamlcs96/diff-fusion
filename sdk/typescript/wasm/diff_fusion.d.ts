/* tslint:disable */
/* eslint-disable */
export function transform_from_cif(cif: string, schema: string, format_id: string): string;
...
export function resolve(ancestor: string, changelog: string, policy_doc: string, ctx: string): string;
